...
namespace UnityBuilderAction
{
    ...
    public static class BuildScript
    {
        ...
        private static string COMPANY_NAME = "1687563246084382839931";
        ...
        private static string KEYSTORE_PASS = "dominosimulator";
        private static string KEY_ALIAS_NAME = "dominosimulator";
        private static string KEY_ALIAS_PASS = "dominosimulator";
